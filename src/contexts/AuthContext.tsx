...
export function AuthContextProvider({ children }) {
  ...
  //obter url de redirecionamento do usuario
  //AuthSessions.makeRedirectUri({ useProxy: true })

  //não conseguiu ler do arquivo .env ler doc passo a passo com tudo que foi tentado
  //process.env.CLIENT_ID,

  const [request, response, promptAsync] = Google.useAuthRequest({
    clientId: '206709171842-e2liv2887eco98dfpv6g40p3mp8vs9aj.apps.googleusercontent.com',
